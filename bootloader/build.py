...
OVMF_FW = WORKSPACE_DIR /  "OVMFbin" / "OVMF_CODE-pure-efi.fd"
OVMF_VARS = WORKSPACE_DIR / "OVMFbin" / "OVMF_VARS-pure-efi.fd"
...
def build_command():
  ...
  # Writea startup script to make UEFI Shell load into
